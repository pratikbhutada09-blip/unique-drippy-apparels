  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        {/* Glow Effects */}
        <div className="absolute -top-20 left-10 w-96 h-96 rounded-full bg-brand-accent/10 blur-[140px] animate-pulse"></div>

        <div className="absolute bottom-0 right-10 w-96 h-96 rounded-full bg-brand-teal/10 blur-[140px] animate-pulse"></div>
      </div>
      ...
      <div className="relative z-10 container-custom text-center">
        ...
        <motion.h1
          ...
          className="font-display font-bold text-5xl md:text-7xl lg:text-8xl leading-tight text-black"
        >
          WE DON'T
          <br />
        ...
        <motion.p
          ...
          className="mt-8 max-w-3xl mx-auto text-lg md:text-xl text-gray-700"
        >
        ...
        >
          ...
          <a
            href="#customize"
            className="secondary-btn border border-gray-300 text-black hover:bg-gray-100"
          >
        ...
        <motion.div
          ...
          className="mt-14 flex flex-wrap justify-center gap-6 text-sm uppercase tracking-[0.25em] text-gray-600"
        >
