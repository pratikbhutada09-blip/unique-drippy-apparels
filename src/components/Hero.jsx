  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-brand-light">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1523381210434-271e8be1f52b?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center bg-no-repeat opacity-40"></div>
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/80 to-brand-dark"></div>
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-20">
        ...
        >
          <a href="#collections" className="w-full sm:w-auto px-8 py-4 bg-brand-teal text-white rounded-none font-bold tracking-widest uppercase hover:bg-brand-blue transition-all duration-300 hover:shadow-[0_0_20px_rgba(13,148,136,0.5)]">
            Explore Collection
          </a>
          <a href="#customize" className="w-full sm:w-auto px-8 py-4 bg-transparent border border-white/30 text-white rounded-none font-bold tracking-widest uppercase hover:bg-white hover:text-black transition-all duration-300">
            Customize Now
          </a>
        </motion.div>
      </div>
