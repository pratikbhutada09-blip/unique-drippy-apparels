      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="section-title mt-4">
            Curated <span className="text-gradient">Streetwear</span>
          </h2>
          ...
          {categories.map((item, index) => (
            ...
            >
              ...
              <div className="absolute top-5 left-5">
                ...
                <span className="bg-brand-accent text-black font-bold px-3 py-1 rounded-full text-xs tracking-widest">
                  {item.badge}
                </span>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <button
                  className="mt-5 px-6 py-3 rounded-full bg-white text-black font-semibold transition duration-300 hover:bg-brand-accent hover:text-black"
                >
                  Explore →
                </button>
