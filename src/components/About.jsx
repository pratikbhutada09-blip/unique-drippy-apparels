 ...
 > <div className="container-custom">
    ...
    <div className="text-center mb-16">
      ...
      <h2 className="mt-4 text-5xl font-display font-bold text-black">
        More Than
        <span className="text-brand-accent"> Apparel</span>
      </h2>
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-20">
      ...
      {stats.map((item, index) => (
        <motion.div
          ...
          className="bg-white border border-gray-200 rounded-3xl p-8 text-center shadow-lg"
        >
    ...
    <div className="mt-20">
      ...
      <h3 className="text-center text-4xl font-display text-black mb-12">
        Why Choose Us
      </h3>
